      ...
      children:[
        {
          path:'lineCharts',
          name:'折线图',
          component: addRoute('v-lineCharts'),
        },
        {
          path:'bieCharts',
          name:'柱状图',
          component: addRoute('v-bieCharts'),
        }
      ]
    },
    //表格模块
      ...
      children:[
        {
          path:'table1',
          name:'table1',
          component: addRoute('v-table1'),
        },
        {
          path:'table2',
          name:'table2',
          component: addRoute('v-table2'),
        }
      ]
    },
    //地图模块
      ...
      children:[
        {
          path:'gaodeMap',
          name:'高德地图',
          component: addRoute('v-gaodeMap'),
        },
        {
          path:'baiduMap',
          name:'百度地图',
          component: addRoute('v-baiduMap'),
        },
        {
          path:'gugeMap',
          name:'谷歌',
          component: addRoute('v-gugeMap'),
        }
      ]
    }
  ]
